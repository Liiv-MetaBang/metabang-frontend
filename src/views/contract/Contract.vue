<template>
    <div class="wrap components-page">
        <div class="wrapB">
            <div class="wrap">
                <HeaderComponent headerTitle="계약서 작성 📑" :isBack="true" />
            </div>
            <v-row justify="center">
                <h2 style="text-align:center; color:black; font-family:'NEXON Lv1 Gothic OTF';">집 계약이 얼마 남지 않았어요!🎉</h2>
            <v-dialog
            v-model="dialog"
            width="600px"
            >
            ...
            <v-card>
                <v-card-title>
                <span class="text-h5" style="font-family:'NEXON Lv1 Gothic OTF'; border:solid">00원룸 계약서</span>
                </v-card-title>
